...
- fauria_:vsftpd
  - 阿里云: `registry.cn-hangzhou.aliyuncs.com/jiangood/images:fauria___vsftpd`
  - ghcr: `ghcr.io/jiangood/docker-pull-cn:fauria___vsftpd`
...
- python:3.14-slim
  - 阿里云: `registry.cn-hangzhou.aliyuncs.com/jiangood/images:python__3.14-slim`
  - ghcr: `ghcr.io/jiangood/docker-pull-cn:python__3.14-slim`
